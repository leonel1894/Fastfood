...
import { BsFillCartFill, BsFillSafe2Fill } from "react-icons/bs"
    ...
    return (
        <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
            ...
            <div className="flex items-center">
                ...
                <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px] ml-1">
            ...
            <div className="fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300">
                ...
                <nav>
                    <ul className="flex flex-col p-4 text-gray-800">
                        ...
                        <li className="text-xl py-4 flex"><BsFillSafe2Fill size={25} className="mr-4" />Best Ones</li>
